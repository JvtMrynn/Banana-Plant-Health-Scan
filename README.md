...
- Admin publishes a direct HTTPS URL (GitHub Releases asset recommended) and a new `version` to Firestore doc `ml_models/yolov8` with fields:
  ```json
  { "version": 1.0.0-ptl-v1, "url": "[https://…/model.ptl](https://github.com/JvtMrynn/Banana-Plant-Health-Scan/releases/download/v1.0.0-ptl-v1/yolov8_disease_v1.ptl)", "updatedAt": 1700000000000 }
  ```
